...
const plans: PricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Bulk Creator Upload (CSV Import & Export)",
      "Content Planner",
      "Payout Management",
      "Custom Reports",
      "Priority Support",
...
const comparisonRows: { feature: string; values: ComparisonValue[] }[] = [
  ...
  { feature: "Campaign Comparison", values: [true, false, true, true] },
  { feature: "Creator Comparison", values: [true, false, true, true] },
  {
    feature: "Bulk Creator Upload (CSV Import & Export)",
